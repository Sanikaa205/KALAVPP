...
const stats = [
  { label: "Total Orders", value: "12", icon: ShoppingBag, color: "bg-blue-50 text-blue-700" },
  { label: "Wishlist Items", value: "8", icon: Heart, color: "bg-pink-50 text-pink-700" },
  { label: "Active Commissions", value: "2", icon: Brush, color: "bg-amber-50 text-amber-700" },
  { label: "Total Spent", value: formatPrice(45600), icon: TrendingUp, color: "bg-emerald-50 text-emerald-700" },
];
